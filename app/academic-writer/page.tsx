        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {[
            ...
            { 
              ...
              desc: 'Essays, research papers, reports, and case studies' 
            },
            { 
              icon: '💾', 
              title: 'Export Options', 
              desc: 'Download as Markdown, copy to clipboard, or print as PDF' 
            },
            { 
              icon: '⚡', 
              title: 'Fast Generation', 
              desc: 'Get your academic content in under 30 seconds' 
            }
          ].map(f => (
